...
# Enhanced NFC
$(call inherit-product, vendor/BlackBox/config/nfc_enhanced.mk)

# Inherit some common BlackBox-OS stuff.
$(call inherit-product, vendor/BlackBox/config/common_full_phone.mk)

PRODUCT_NAME := blackbox_bacon
